...
3. Created a table named <em>Cleaned_Data</em> after data cleaning and saved a pdf version of the table on [*./Reports/1. Pre_Processing_Report/Cleaned_Dataset.pdf*](https://github.com/n1sarga/Salary_Data_Analysis/blob/main/Reports/1.%20Pre_Processing_Report/Cleaned_Dataset.pdf)
